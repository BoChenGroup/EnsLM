...
from my_dataset import get_loader
#########################################################
## Input Parameters
#########################################################
...
## Dataset
parser.add_argument('--dataset', type=str, choices=['mtl_data'], default='mtl_data', help='dataset (default: mnist)')
parser.add_argument('--seed', type=int, default=0, help='random seed (default: 0)')
parser.add_argument('--train_dir', type=str, default='../dataset/mtl_dataset.pkl', help='dataset path of training')
...
## Architecture
parser.add_argument('--num_classes', type=int, default=16, help='number of classes (default: 10)')
parser.add_argument('--gaussian_size', default=16, type=int, help='gaussian size (default: 64)')
...
## Read Data
#########################################################
train_iter, vocab_size, class_num, index2word = get_loader(args.train_dir, batch_size=args.batch_size, train_flag=True)
test_iter, vocab_size, class_num, index2word = get_loader(args.train_dir, batch_size=args.batch_size, train_flag=False)

## Calculate flatten size of each input data
args.input_size = vocab_size
print(args.input_size)
#########################################################
## Train and Test Model
#########################################################
gmvae = GMVAE(args)
history_loss = gmvae.train(train_iter, test_iter)
