...
from my_dataset import get_train_loader_r8, get_test_loader_r8
...
## Dataset
parser.add_argument('--dataset', type=str, choices=['r8'], default='r8', help='dataset (default: mnist)')
...
## Architecture
parser.add_argument('--num_classes', type=int, default=8, help='number of classes (default: 10)')
parser.add_argument('--gaussian_size', default=8, type=int, help='gaussian size (default: 64)')
...
train_loader, voc, v = get_train_loader_r8('data/r8_data.pkl', train_flag=True, batch_size=args.batch_size)
test_loader, voc, v = get_test_loader_r8('data/r8_data.pkl', train_flag=False, batch_size=args.batch_size)
